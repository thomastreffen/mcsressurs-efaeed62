...
import { FileText, PenLine, XCircle, UserPlus, UserMinus } from "lucide-react";

const actionIcons: Record<EventLog["actionType"], React.ReactNode> = {
  created: <FileText className="h-3.5 w-3.5 text-status-accepted" />,
  updated: <PenLine className="h-3.5 w-3.5 text-status-pending" />,
