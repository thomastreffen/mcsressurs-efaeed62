import { Shield, CheckCircle2, AlertTriangle, Info, Pin, PinOff, BookMarked, ThumbsUp, ThumbsDown, ShieldCheck, ShieldX, FileText } from "lucide-react";
...
export function RegulationAnswerCard({ query, onPin, onRate, onReview, canReview, compact, onClick }: Props) {
        ...
        {canReview && onReview && reviewStatus === "draft" && (
          <div className="flex items-center gap-1 ml-auto">
            <Button
              ...
              onClick={() => onReview(query.id, "approved")}
            >
            ...
            <Button
              ...
              onClick={() => onReview(query.id, "rejected")}
            >
